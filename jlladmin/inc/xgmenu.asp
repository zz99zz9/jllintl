...
rs.close
  ...
  <li class="sub-menu nav5">
                      ...
                      <ul class="sub">
                          <li class="nav5-1"><a class="" href="Prod_list.Asp?Prod_Type=8">市场报告列表</a></li>
                          <li class="nav5-2"><a class="" href="Prod_add.asp?Prod_Type=8">发布市场报告</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu nav6">
                                        ...
                                        <ul class="sub">
                                            <li class="nav6-1"><a class="" href="links.asp?c=1">PC广告管理</a></li>
                                            <li class="nav6-2"><a class="" href="links.asp?c=2">Mobile广告管理</a></li>
                                            <li class="nav6-3"><a class="" href="links.asp?c=3">Tags管理</a></li>
                                        </ul>
                                    </li>
<!--<li class="sub-menu nav6">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub">
                          <li class="nav6-1"><a class="" href="#">首页广告管理</a></li>
                          <li class="nav6-2"><a class="" href="#">发布广告图片</a></li>
                      </ul>
                  </li>-->
                  <li>
