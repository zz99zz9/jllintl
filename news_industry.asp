...
<div class="w ">
  ...
  <div class="position"><a href="index.asp">JLL</a> &gt; <a href="news.asp">热点资讯 &gt; <a href="news_list.asp?cid=12">行业洞察
  </a> </div>
</div>
...
rs.Open "select * from [prod] where classid=12 order by oid desc,prod_id desc",conn,1,1%>
<% 
